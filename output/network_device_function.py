...
class iSCSIBootField(base.CompositeField):
    ...
    primary_target_tcp_port = base.Field("PrimaryTargetTCPPort", adapter=rsd_lib_utils.num_or_none)
    ...
    primary_vlan_id = base.Field("PrimaryVLANId", adapter=rsd_lib_utils.num_or_none)
    ...
    secondary_target_tcp_port = base.Field("SecondaryTargetTCPPort", adapter=rsd_lib_utils.num_or_none)
    """The TCP port for the secondary iSCSI boot target."""

    secondary_lun = base.Field("SecondaryLUN", adapter=rsd_lib_utils.num_or_none)
    ...
    secondary_vlan_id = base.Field("SecondaryVLANId", adapter=rsd_lib_utils.num_or_none)
    ...
    router_advertisement_enabled = base.Field("RouterAdvertisementEnabled", adapter=bool)
...
class NetworkDeviceFunction(rsd_lib_base.ResourceBase):
    ...
    i_scsi_boot = iSCSIBootField("iSCSIBoot")
    """iSCSI Boot."""
